    ...
    <div className="item-list-container">
      ...
      <div className="container text-center">
        <div className="wrapper">          
          {libros.map(({ id, titulo, autor, categoria, img, precio, btnText }, index) => (
            <Cards
              key={index}
              titulo={titulo}
              autor={autor}
